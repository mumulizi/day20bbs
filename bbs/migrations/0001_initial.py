# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-15 01:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', '草稿'), ('published', '已发布'), ('hidden', '隐藏')], default='published', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_childern', to='bbs.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
